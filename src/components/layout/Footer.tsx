    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Empresa dedicada a la venta de servicios de internet y televisión, 
              conectando hogares y empresas en zonas urbanas y rurales a través 
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <div className="flex items-center">
                ...
                <span>Zonas urbanas y rurales</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Almeidas Comunicaciones SAS. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
